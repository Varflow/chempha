<template>
  <div class="header-mobile d-block d-lg-none" :class="{ active: opened }">
    <div class="header-mobile__header">
      ...
      <div class="header-mobile__btn header-mobile-close" @click="$emit('close')">
        <div class="line"></div>
        <div class="line"></div>
      </div>
    </div>
    ...
    <div class="header-mobile__menu">
      <NuxtLink @click="$emit('close')" to="/company" class="header-menu__link">Company</NuxtLink>
      <div class="header-menu__link">
        <div class="header-menu__link-label" @click="toggleCategory">
          Ingredients
          <svg
        ...
        <div
          ...
          :class="{ active: categoryOpened }"
        >
          <div class="header-menu__link" v-for="category of ingredientsForView">
            <div class="header-menu__link-label" @click="toggleSubCategory">
              {{ category.name }}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                id="Outline"
            ...
            <div
              ...
              :class="{ active: subcategoryOpened }"
              v-if="category.children"
            >
              <NuxtLink
      ...
      <NuxtLink @click="$emit('close')" to="/partners" class="header-menu__link">Partners</NuxtLink>
      <NuxtLink @click="$emit('close')" to="/news" class="header-menu__link">News</NuxtLink>
      <NuxtLink @click="$emit('close')" to="/contact-us" class="header-menu__link"
        >Contact Us</NuxtLink
      >
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    toggleSubCategory() {
      this.subcategoryOpened = !this.subcategoryOpened;
    },

    closeSubCategory() {
      this.subcategoryOpened = false;
    },
  },
};
</script>
